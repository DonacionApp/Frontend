...
import { NeedPublicationService as DonationService, UserLike } from '../../../core/services/post.service';
...
export class LikesModalComponent implements OnChanges, OnDestroy {
  ...
  constructor(
    @Inject(DonationService) private readonly donationService: DonationService,
  ...
  trackByUserId(index: number, userLike: UserLike): string {
    return userLike.user?.username || userLike.user?.email || index.toString();
  }
