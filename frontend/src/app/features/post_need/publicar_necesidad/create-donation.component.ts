...
import { DonationService, CreateDonationDTO, Article, Comment } from '../../../core/services/post.service';
    ...
    createObservable.subscribe({
      ...
      error: (error) => {
        ...
        if (error.status === 400) {
          ...
          this.errorMessage = error.error?.message || 'Error al publicar la necesidad. Por favor intenta nuevamente.';
        }
      }
    });
  }
